"""
Django settings for tasker_giedrius project.
...
SECRET_KEY = 'django-insecure-mps5-@6&z2s=*l-9_hsw0)os_itb28wnw9e__!-n$#3y2e14^y'
...
ROOT_URLCONF = 'tasker_giedrius.urls'
...
WSGI_APPLICATION = 'tasker_giedrius.wsgi.application'
