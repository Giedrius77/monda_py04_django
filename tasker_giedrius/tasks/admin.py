...
class ProjectAdmin (admin.ModelAdmin):
    list_display = ['id', 'name', 'total_tasks', 'undone_tasks', 'owner', 'recent_tasks'] # stulpeliu pavadinimai project skiltyje pagal eiliskuma - 'id', stulpelis nera butinas, bet galima tureti
    list_display_links =['id', 'name'] # 'id', stulpelis nera butinas, bet galima tureti
    list_filter = ['owner']
    search_fields = ['name']
    fieldsets = (
        (None, {
